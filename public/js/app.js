...
var notyMessage = function notyMessage() {
  ...
  var msg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'There is no message to display!';
  var notyTimeout = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1000;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            username = registerFormEle.elements['username'].value;
            email = registerFormEle.elements['email'].value;
            password = registerFormEle.elements['password'].value; // serialize form data

            registerFormData = qs__WEBPACK_IMPORTED_MODULE_3___default().stringify({
              username: username,
              email: email,
              password: password
            });
          ...
          case 8:
            ...
            if (errors.username) {
              ...
              notyMessage('error', 'Name must not contain anything other than alphabet', timeout);
            }
            ...
            if (errors.password) {
              notyMessage('error', 'Password must be at least 8 characters long', timeout);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            email = loginFormEle.elements['email'].value;
            password = loginFormEle.elements['password'].value; // serialize form data

            loginFormData = qs__WEBPACK_IMPORTED_MODULE_3___default().stringify({
              email: email,
              password: password
            });
            _context3.prev = 4;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgardenly"] = self["webpackChunkgardenly"] || [];
